...
**File**: `e2e/landing.spec.ts` (21 tests)
...
| 9 | Compares pricing | Free/Pro/Enterprise tiers, $18 early bird, Enterprise CTA disabled | ✅ |
| 10 | Hits bottom CTA | "Get Started Free" → /signup | ✅ |
| 11 | Checks footer | LinkedIn link correct, copyright present | ✅ |
| 12 | (Behind the scenes) | Umami analytics script loaded with correct website ID | ✅ |
